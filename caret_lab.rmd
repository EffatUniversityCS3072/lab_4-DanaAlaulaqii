...
model_compare <- resamples(list(LDA = model_LDA, CART =model_CART,KNN = model_KNN, SVMLinear =model_SVM, RF=model_rf))
...
confusionMatrix(referance = testData$Species, predicted)
